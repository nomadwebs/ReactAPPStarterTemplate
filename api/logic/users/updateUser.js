...
export default (userId, targetUserId, username, email, name, surname1, surname2, dni, biography, country, province, city, postalCode, address1, address2, number, flat, website) => {
    ...
    return User.findById(userId)
        ...
        .then(user => {
            ...
            return User.findByIdAndUpdate(targetUserId, { username, email, name, surname1, surname2, dni, biography, country, province, city, postalCode, address1, address2, number, flat, website }, { new: true, runValidators: true })
                .catch(error => {
