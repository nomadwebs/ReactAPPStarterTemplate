...
export default function UserProfile(props) {
    ...
    const handleUpdateClick = event => {
        ...
        try {
            logic.updateUser(userData.id, userData.id, username, email, name, surname1, surname2, dni, biography, country, province, city, postalCode, address1, address2, number, flat, website)
                .then(() => {
